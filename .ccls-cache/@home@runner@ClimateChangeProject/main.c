...
int main(void) {
  char dummy_char[10000] = {"This was made by Antonio Souza"}; 
...
//The report for this program can be found @: https://docs.google.com/document/d/1j38gr2HTzl1wlbMh3zQGK1b9uxmxhlyeT-mq9DvS070/edit?usp=sharing